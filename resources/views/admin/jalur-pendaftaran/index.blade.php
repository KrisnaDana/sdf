...
<div class="row column_title">
    <div class="col-md-12">
        ...
        <div class="row">
                ...
                <div class="col">
                    <a href="{{route('admin-view-create-jalur-pendaftaran')}}"><button type="button" class="btn cur-p btn-lg btn-success mr-3" style="float: right;">Tambah</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="white_shd full margin_bottom_30 padding_40">
            <div class="padding_infor_info" style="display:flex;">
                ...
                <div class="col">
                    <a href="{{route('admin-view-jalur-pendaftaran')}}"><button type="button" class="btn btn-outline-secondary m-0" id="btn-refresh" style="float:right;"><i class="fa fa-refresh text-secondary"></i></button></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table" id="table">
                        ...
                        <tbody>
                            ...
                            <div class="modal fade" id="delete-modal{{$loop->index+1}}">
                                <form method="post" action="{{route('admin-delete-jalur-pendaftaran', ['id' => $jalur_pendaftaran->id])}}">
                                    @csrf
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah anda yakin ingin menghapus {{$jalur_pendaftaran->nama}}?
                                            </div>
