...
<div class="row column_title">
    <div class="col-md-12">
        ...
        <div class="row">
                ...
                <div class="col">
                    <a href="{{route('admin-view-create-berkas')}}"><button type="button" class="btn cur-p btn-lg btn-success mr-3" style="float: right;">Tambah</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="white_shd full margin_bottom_30 padding_40">
            <div class="padding_infor_info" style="display:flex;">
                ...
                <div class="col">
                    <a href="{{route('admin-view-berkas')}}"><button type="button" class="btn btn-outline-secondary m-0" id="btn-refresh" style="float:right;"><i class="fa fa-refresh text-secondary"></i></button></a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route('admin-download-berkas', ['id' => $b->id])}}" target="_blank"><button type="button" class="btn btn-success"><i class="fa fa-download text-white"></i></button></a>
                            ...
                            <div class="modal fade" id="delete-modal{{$loop->index+1}}">
                                <form method="post" action="{{route('admin-delete-berkas', ['id' => $b->id])}}">
                                    @csrf
