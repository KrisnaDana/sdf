...
<body>
    <table class="tabel1">
        <tr>
            <td rowspan="6" style='width: 5%;'><img src="{{ public_path('img/UNUD.png') }}" alt="" height="100px"
                    width="100px"></td>
            <td style='width: 90%;'>&nbsp;</td>
            <td rowspan="6" style='width: 5%;'><img src="{{ public_path('img/TEKNIK_1.png') }}" alt="" height="100px"
                    width="100px"></td>
        </tr>
        <tr>
        </tr>
    ...
    <table class="tabel2">
        <tr>
            <td colspan="8"
                style='text-align: center; font-size: 20px; font-weight:bold; border: 2px solid black; text-transform: uppercase;'>
                BIODATA MAHASISWA {{ $program_studi }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="7" style='text-transform: uppercase;' class="hideextra">Sekarang : {{ $user->alamat_sekarang }}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td rowspan="8" colspan="2" style='vertical-align: top; padding-left: 50px; border-style: none;'><img
                    src="{{ $user->pas_foto ? public_path('mahasiswa/pas_foto/'.$user->pas_foto) : public_path('img/foto3x4.jpg') }}"
                    alt="" height=150px width=120px></td>
            <td colspan="6" style='text-align: center; border-bottom:none; border-top:none; border-left:none;'>Denpasar,
                ___________________{{ date('Y') }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6" style='text-align: center; border-bottom:none; border-top:none; border-left:none;'>
                (.............................................................)</td>
        </tr>
        <tr>
